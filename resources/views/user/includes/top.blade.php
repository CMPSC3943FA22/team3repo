<header class="app-header navbar">
  ...
  <a class="navbar-brand" href="{{ route('user.category')}}">
    <img class="navbar-brand-full" src="{{ asset('images/avatar.png')}}" style="width:50px;" alt="BHS">
    <img class="navbar-brand-minimized" src="" style="width:50px;"  alt="Music E-Commerce">
  </a>
